package com.wmh.realtime.app.dws;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.PropertyNamingStrategy;
import com.alibaba.fastjson.serializer.SerializeConfig;
import com.wmh.realtime.app.BaseAppV1;
import com.wmh.realtime.bean.UserLoginBean;
import com.wmh.realtime.common.Constant;
import com.wmh.realtime.util.CommonUtil;
import com.wmh.realtime.util.FlinkSinkUtil;
            ...
            .reduce(
                ...
                new ProcessAllWindowFunction<UserLoginBean, UserLoginBean, TimeWindow>() {
                    ...
                    public void process(Context ctx,
                        ...
                        bean.setStt(CommonUtil.toDateTime(ctx.window().getStart()));
                        bean.setEdt(CommonUtil.toDateTime(ctx.window().getEnd()));
                        
                        bean.setCurDate(CommonUtil.toDate(System.currentTimeMillis()));
        ...
        return loginDataStream
            ...
            .process(new KeyedProcessFunction<String, JSONObject, UserLoginBean>() {
                ...
                public void processElement(JSONObject obj,
                    ...
                    String thisLoginDate = CommonUtil.toDate(ts);
                    // 最后一次登录日期
                    ...
                    if (!thisLoginDate.equals(lastLoginDate)) {
                        ...
                        if (lastLoginDate != null) {
                            Long thisLoginTs = CommonUtil.toTs(thisLoginDate);
                            Long lastLoginTs = CommonUtil.toTs(lastLoginDate);
