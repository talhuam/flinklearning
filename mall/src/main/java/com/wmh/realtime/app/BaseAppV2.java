package com.wmh.realtime.app;

import com.wmh.realtime.util.FlinkSourceUtil;
...
public abstract class BaseAppV2 {
    ...
    public void init(int port, int p, String ckPathGroupIdJobName, String ... topics){
        ...
        System.setProperty("HADOOP_USER_NAME", "wangmh");
        ...
        env.getCheckpointConfig().setCheckpointStorage("hdfs://bigdata01:8020/ck/" + ckPathGroupIdJobName);
