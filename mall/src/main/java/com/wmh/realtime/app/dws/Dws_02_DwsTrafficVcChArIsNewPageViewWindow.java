...
import com.wmh.realtime.app.BaseAppV2;
import com.wmh.realtime.bean.TrafficPageViewBean;
...
import static com.wmh.realtime.common.Constant.*;
            ...
            .reduce(
                ...
                new ProcessWindowFunction<TrafficPageViewBean, TrafficPageViewBean, String, TimeWindow>() {
                    ...
                    public void process(String key,
                        ...
                        bean.setCurDate(CommonUtil.toDate(System.currentTimeMillis())); // 统计日期
